            ...
            <div className="_feed_inner_text_area  _b_radious6 _padd_b24 _padd_t24 _padd_r24 _padd_l24 _mar_b16">
                <div className="_feed_inner_text_area_box">
                    ...
                    <div className="form-floating _feed_inner_text_area_box_form ">
                        <textarea className="form-control _textarea" placeholder="Leave a comment here" id="floatingTextarea" value={postText}
                        onChange={(e) => setPostText(e.target.value)}></textarea>
                        <label className="_feed_textarea_label" htmlFor="floatingTextarea"
                        
                        style={{
                            position: 'absolute',
                            top: postText ? '-10px' : '0px',
                            left: postText ? '10px' : '15px',
                            fontSize: postText ? '0px' : '16px',
                            color: postText ? '#666' : '#aaa',
                ...
                <div className="_feed_inner_text_area_bottom">
                    ...
                    <div className="_feed_inner_text_area_btn">
                        <button type="button" className="_feed_inner_text_area_btn_link" onClick={handleClick}>
